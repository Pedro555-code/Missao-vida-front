...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto">
    <table
      ref={ref}
      className={cloneAndAddClass("w-full caption-bottom text-sm", className)}
      {...props}
    />
  </div>
))
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cloneAndAddClass("[&_tr]:border-b", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cloneAndAddClass("[&_tr:last-child]:border-0", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cloneAndAddClass("mt-4 text-sm text-zinc-500 dark:text-zinc-400", className)}
    {...props}
  />
))
